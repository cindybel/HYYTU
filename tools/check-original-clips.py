...
out=Path('video/originals');report=[];sheet=Image.new('RGB',(960,420),(5,10,20));d=ImageDraw.Draw(sheet)
...
sheet.save('documentation/qa/original-clips-contact.jpg');Path('documentation/qa/original-clips-encoding.json').write_text(json.dumps(report,indent=2));print(json.dumps(report))
