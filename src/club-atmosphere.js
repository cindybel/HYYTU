...
(()=>{
 ...
 link.rel='stylesheet';
 link.href='./src/ui-ux.css?phase=quality-20260915';
...
window.ClubAtmosphere=(()=>{
 ...
 function tick(){
  ...
  for(const {light,base} of lamps){
   ...
   const drift=reduced?1:1+Math.sin(liveShow.elapsed*Math.PI*(liveShow.showProfile?.bpm||120)/120)*atmosphere.motion;
...
/* StudioLife owns the physical studio projector. Venue rigs are hidden by
