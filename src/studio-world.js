...
window.StudioWorld=(()=>{
 ...
 function getWorldAction(){
  if(visit)return null;const physical=window.PhysicalV4?.interaction?.();if(physical)return{source:'physical',...physical};
