...
window.DesktopFocus=(()=>{
 ...
 const iconMap={calendar:'▶',guide:'?',phone:'☎',email:'✉',social:'◆',transport:'↗',music:'♫',stats:'▥',inventory:'▣',finance:'$',settings:'⚙',skills:'★',shop:'◇'};
...
window.VJPolish=(()=>{
 ...
 const appNames={calendar:'Sessions',social:'Shows',email:'Email',inventory:'Inventaire',shop:'Shop',skills:'Skills',finance:'Finance',music:'Player',settings:'Réglages',phone:'Contacts',transport:'Uver',stats:'Stats',guide:'Guide VJ'};
 let lastTitle='';
