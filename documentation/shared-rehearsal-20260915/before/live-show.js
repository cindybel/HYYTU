...
class VJLiveShow {
  constructor(root, clips) {
    ...
    root.querySelector('.live-cue').after(guide);this.phaseNodes=[...guide.querySelectorAll('[data-phase]')];this.beatNodes=[...guide.querySelectorAll('.live-beats i')];
    ...
    ClipBrowser.mount(deck.querySelector('.resolute-live-clips'),clips,index=>{if(this.paused||this.transition||this.queuedAt!=null||this.completed)return false;this.prepare(index);},this.previewIndex);
